...
type Manager struct {
	...
	// ExtraExtensions are used when generating a new CSR (Certificate GetProductCandidate),
...
// request path and query. It responds with 400 Bad GetProductCandidate to all other HTTP methods.
